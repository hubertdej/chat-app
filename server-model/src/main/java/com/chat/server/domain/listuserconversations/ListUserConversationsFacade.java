...
public class ListUserConversationsFacade {
    ...
    public ListUserConversationsFacade(
        ...
        conversationRepository.addConversationObserver(observer);
    }
    ...
    private final ConversationRepository.ConversationObserver observer = new ConversationRepository.ConversationObserver() {
        @Override
