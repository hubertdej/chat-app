...
public class MessageReceiverFacade {
    ...
    public void receiveMessage(ServerMessagingSession session, FromMessageDto webSocketMessageDto) throws NoSuchConversationException, MessagingSessionException, JsonProcessingException {
